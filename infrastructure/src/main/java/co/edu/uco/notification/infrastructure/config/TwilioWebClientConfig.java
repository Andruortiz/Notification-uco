...
@Configuration
@EnableConfigurationProperties(TwilioProviderProperties.class)
public class TwilioWebClientConfig {

  @Bean
  WebClient twilioWebClient(final TwilioProviderProperties properties) {
